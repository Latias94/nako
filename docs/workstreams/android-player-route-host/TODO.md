...
- [x] APRH-030 - Move route orchestration out of `PlaybackPlayerRoute`.
  ...
  - Evidence: `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.screens.player.* --no-daemon --no-parallel` passed on 2026-05-20.
