...
- [x] NSB-020 [owner=codex] [deps=NSB-010] [scope=crates/nako-vfs/src/lib.rs,crates/nako-vfs/src/local.rs,crates/nako-vfs/src/cache.rs]
...
- [x] NSB-030 [owner=codex] [deps=NSB-020] [scope=crates/nako-nfo/src/export.rs,crates/nako-nfo/src/summary.rs,crates/nako-nfo/src/lib.rs]
