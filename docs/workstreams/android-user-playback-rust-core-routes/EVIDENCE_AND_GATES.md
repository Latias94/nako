...
- `crates/taru-client-core/src/user_playback.rs`
...
- `apps/android/app/src/main/java/dev/taru/android/userplayback/RustUserPlaybackCore.kt`
- `apps/android/app/src/test/java/dev/taru/android/userplayback/TaruUserPlaybackClientTest.kt`
...
- Added `crates/taru-client-core/src/user_playback.rs`.
...
- Added
  `apps/android/app/src/main/java/dev/taru/android/userplayback/RustUserPlaybackCore.kt`.
- Migrated `TaruUserPlaybackClient` runtime request construction from
  `TaruPublicClientRequests` to `UserPlaybackCore`/Rust UniFFI request
  descriptors.
