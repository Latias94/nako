...
- [x] NSW-020 [owner=codex] [deps=NSW-010] [scope=crates/taru-vfs/src/lib.rs,crates/taru-vfs/src/local.rs,crates/taru-vfs/src/cache.rs]
  ...
  `cargo nextest run -p taru-vfs local::tests::local_backend_atomic --no-fail-fast`.
...
- [x] NSW-030 [owner=codex] [deps=NSW-020] [scope=crates/taru-nfo/src/export.rs,crates/taru-nfo/src/summary.rs,crates/taru-nfo/src/lib.rs]
