...
- [x] ARB-010 [owner=planner] [deps=none] [scope=docs/workstreams/android-route-back-stack-refactor]
  ...
  tested route stack model and wire it into `TaruBrowseShell`.

## M1 - Route Stack Model And Shell Wiring

- [x] ARB-020 [owner=codex] [deps=ARB-010] [scope=apps/android/app/src/main/java/dev/taru/android/ui/browse,apps/android/app/src/test/java/dev/taru/android/ui/browse]
  ...
  Handoff: Completed on 2026-05-19. Implemented `TaruBrowseNavigationState`
  and `TaruRouteStack`, wired `TaruBrowseShell` through open/back/destination
