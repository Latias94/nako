...
- [x] AUP-020 [owner=codex] [deps=AUP-010] [scope=apps/android/app/src/main/java/dev/nako/android/ui/screens/player,apps/android/app/src/test/java/dev/nako/android/ui/screens/player]
  ...
  clearance for Nako Player context chrome and focused test coverage for the
  layout policy.
