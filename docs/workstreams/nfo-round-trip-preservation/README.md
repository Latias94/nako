...
This workstream deepens `nako-nfo` before library file write/link policy work.
The current exporter can generate Nako-owned movie XML, but forced export over
...
M47 makes NFO export preserve unknown XML fields, update only Nako-owned fields,
