...
- [x] ABSH-020 - Add browse shell host state module.
  ...
  - Scope:
    ...
    - `apps/android/app/src/test/java/dev/nako/android/ui/browse/BrowseShellHostTest.kt`
  - Validation:
...
- [x] ABSH-030 - Move client runtime assembly out of `NakoBrowseShell`.
  - Owner: Codex
  - Scope:
    - `apps/android/app/src/main/java/dev/nako/android/ui/browse/ClientBrowseShellRuntime.kt`
