...
DTO and route mirrors by introducing a generated Kotlin/JVM SDK from Nako's Public
OpenAPI v1 contract.
...
produced by `nako-api`, compile-checked by Gradle, validated against the same
