...
- 2026-05-19: AUSA-020 moved browse navigation actions behind
  ...
  `NakoBrowseShell` navigation callbacks through `BrowseAction`.
  Gate passed:
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.BrowseSessionTest --tests dev.nako.android.ui.browse.NakoRouteStackTest --tests dev.nako.android.ui.browse.NakoBrowseNavigationStateSaverTest --no-daemon --no-parallel`.
- 2026-05-19: AUSA-030 moved Home, Library Detail, Search, and Browse Facet
  loading behind `BrowseSession` and `BrowseDataSource`. `NakoBrowseShell`
  ...
  Gates passed:
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.BrowseSessionLoadingTest --no-daemon --no-parallel`;
...
- 2026-05-19: AUSA-040 moved Media Item Detail, selected Media Source,
  ...
  `NakoBrowseShell` renders the session state and keeps only playback-start
  ...
  Gates passed:
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.BrowseSessionLoadingTest --tests dev.nako.android.ui.browse.ClientBrowseDataSourceTest --tests dev.nako.android.ui.browse.BrowseSessionTest --no-daemon --no-parallel`;
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --no-daemon --no-parallel`.
- 2026-05-19: AUSA-050 moved playback start orchestration into
  `BrowseSession` through `BrowsePlaybackStarter` and
  `ClientBrowsePlaybackStarter`. `NakoBrowseShell` now dispatches
  ...
  Gates passed:
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.BrowseSessionLoadingTest --tests dev.nako.android.ui.browse.BrowseSessionTest --no-daemon --no-parallel`;
  `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --no-daemon --no-parallel`.
- 2026-05-19: AUSA-060 moved resume-position calculation behind
  `BrowseResumeResolver`, leaving `NakoBrowseShell` as a Compose adapter that
