...
apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.taru.android.player.* --tests dev.taru.android.ui.screens.player.* --no-daemon --no-parallel
```
...
| APSA-020 | Done | `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.taru.android.ui.screens.player.* --no-daemon --no-parallel` passed on 2026-05-20. |
| APSA-030 | Done | `apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.taru.android.player.* --tests dev.taru.android.ui.screens.player.* --no-daemon --no-parallel` passed on 2026-05-20. |
