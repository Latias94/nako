...
- [x] DJR-020 [owner=codex] [deps=DJR-010] [scope=crates/nako-core/src/repository/jobs.rs,crates/nako-db/src/jobs.rs,crates/nako-db/src/tests.rs]
  ...
  Validation: `cargo nextest run -p nako-db running_jobs_failed_on_startup --no-fail-fast`
  passed with 1 test.
...
- [x] DJR-030 [owner=codex] [deps=DJR-020] [scope=crates/nako-server/src/app/startup.rs,crates/nako-server/src/app/tests/startup.rs]
...
- [x] DJR-040 [owner=codex] [deps=DJR-030] [scope=crates/nako-catalog/src/lib.rs]
