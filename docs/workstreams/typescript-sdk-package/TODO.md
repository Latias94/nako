...
- [x] TSP-020 [owner=codex] [deps=TSP-010] [scope=crates/nako-api/src/sdk.rs]
...
- [x] TSP-030 [owner=codex] [deps=TSP-020] [scope=sdk/typescript, crates/nako-api/examples]
...
- [x] TSP-040 [owner=codex] [deps=TSP-030] [scope=crates/nako-api/src/sdk.rs, sdk/typescript]
