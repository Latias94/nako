...
- `crates/taru-client-core/src/playback.rs`
- `crates/taru-client-uniffi/src/lib.rs`
- `apps/android/app/src/main/java/dev/taru/android/playback/TaruPlaybackClient.kt`
- `apps/android/app/src/main/java/dev/taru/android/playback/RustPlaybackCore.kt`
- `apps/android/app/src/main/java/dev/taru/android/browse/BrowseSdkAdapters.kt`
- `apps/android/app/src/test/java/dev/taru/android/playback/TaruPlaybackClientTest.kt`
...
- Added FFI-safe residual playback request input records and explicit builder
  functions to `crates/taru-client-uniffi/src/lib.rs`.
- Fresh gates:
...
guard still reports direct dependencies `taru-client-core` and `uniffi` with no
...
- Extended Android `PlaybackCore`/`RustPlaybackCore` with source probe,
  ...
  descriptors.
- Migrated `TaruPlaybackClient` residual runtime request construction from
  `TaruPublicClientRequests` to Rust/UniFFI request descriptors.
...
`taru-client-core` and `uniffi` as direct dependencies; route-owner and
