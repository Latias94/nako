...
depth work into proposed lanes in `FOLLOW_ONS.md`. `MPDP-050` closed the lane.
...
- Status: DONE
- Evidence: `docs/workstreams/metadata-provider-depth-and-precision/CLOSEOUT.md`
...
- Open a new focused workstream from one of the proposed lanes in
  `FOLLOW_ONS.md`.
