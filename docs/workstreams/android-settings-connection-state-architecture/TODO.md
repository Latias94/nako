...
- [x] ASCSA-020 [owner=codex] [deps=ASCSA-010] [scope=apps/android/app/src/main/java/dev/nako/android/ui/connection,apps/android/app/src/test/java/dev/nako/android/ui/connection]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.connection.* --tests dev.nako.android.connection.* --no-daemon --no-parallel
...
- [x] ASCSA-030 [owner=codex] [deps=ASCSA-020] [scope=apps/android/app/src/main/java/dev/nako/android/ui/screens/settings,apps/android/app/src/test/java/dev/nako/android/ui/screens/settings]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.screens.settings.* --no-daemon --no-parallel
...
- [x] ASCSA-040 [owner=codex] [deps=ASCSA-030] [scope=apps/android/app/src/main/java/dev/nako/android/ui,apps/android/app/src/test/java/dev/nako/android/ui]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.* --tests dev.nako.android.ui.connection.* --tests dev.nako.android.ui.screens.settings.* --no-daemon --no-parallel
  Review: Root should coordinate sessions, not duplicate repository decisions.
  Evidence: focused JVM tests and diff.
  Handoff: DONE. `NakoAppSession` owns root snapshot and connection visibility transitions without changing Browse/Player architecture.
