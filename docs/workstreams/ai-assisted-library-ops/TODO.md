...
- [x] AILO-020 [owner=codex] [deps=AILO-010] [scope=crates/nako-core/src/automation.rs,crates/nako-db,crates/nako-automation,crates/nako-server/src/app/automation.rs]
  ...
  Validation: `cargo nextest run -p nako-db automation --no-fail-fast`;
  `cargo nextest run -p nako-automation --no-fail-fast`; focused server
  ...
  Evidence: `crates/nako-db/src/tests.rs`
  `nako_database_sqlite_lists_generated_artifact_proposals_with_readiness` and
  `nako_database_sqlite_marks_generated_artifact_proposal_stale_after_target_changes`;
...
- [x] AILO-030 [owner=codex] [deps=AILO-020] [scope=crates/nako-api/src/admin.rs,crates/nako-api/src/admin_contract.rs,crates/nako-server/src/http/admin.rs,apps/admin-web/src/adminApi]
...
- [x] AILO-040 [owner=codex] [deps=AILO-030] [scope=crates/nako-server/src/app,crates/nako-core,crates/nako-db,crates/nako-api/src/admin.rs]
  ...
  Evidence: `crates/nako-server/src/app/tests/automation.rs`
