...
- [x] APRA-020 [owner=codex] [deps=APRA-010] [scope=apps/android/app/src/main/java/dev/nako/android/ui/artwork,apps/android/app/src/main/java/dev/nako/android/ui/browse]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.artwork.* --tests dev.nako.android.ui.browse.* --no-daemon --no-parallel
...
- [x] APRA-030 [owner=codex] [deps=APRA-020] [scope=apps/android/app/src/main/java/dev/nako/android/ui/screens/detail,apps/android/app/src/main/java/dev/nako/android/ui/browse]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.BrowseSessionLoadingTest --tests dev.nako.android.ui.artwork.* --no-daemon --no-parallel
...
- [x] APRA-040 [owner=codex] [deps=APRA-030] [scope=apps/android/app/src/main/java/dev/nako/android/ui/browse,apps/android/app/src/main/java/dev/nako/android/ui/screens/player]
  ...
  Validation: apps\android\gradlew.bat -p apps\android :app:testDebugUnitTest --tests dev.nako.android.ui.browse.* --tests dev.nako.android.player.* --no-daemon --no-parallel
