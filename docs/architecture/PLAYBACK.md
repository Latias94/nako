...
| HLS runtime lifecycle | Active invariant freeze | `docs/adr/0052-hls-runtime-and-media-engine-boundary.md`; `docs/workstreams/hls-runtime-lifecycle-boundary/` | Freeze active/reuse/supersede/readiness/cancel/cleanup invariants before artifact I/O pressure, queueing, remote workers, or LL-HLS work. |
...
inventory slices are closed. `hls-runtime-lifecycle-boundary` is active as a
docs/research invariant freeze before HLS lifecycle/resource admission,
artifact I/O pressure, remote workers, LL-HLS/CMAF, or player-facing follow-ons.
