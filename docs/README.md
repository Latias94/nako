...
- [Architecture deep dives](architecture/README.md): playback, storage/VFS,
  library pipeline, state/access, realtime/sync, operations/release,
  control-plane, and workstream-link maps.
