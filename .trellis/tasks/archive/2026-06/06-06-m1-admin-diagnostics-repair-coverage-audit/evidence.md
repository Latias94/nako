...
- `python ./.trellis/scripts/task.py validate .trellis/tasks/06-06-m1-admin-diagnostics-repair-coverage-audit`
...
- `git diff --check -- docs/ROADMAP.md docs/GOALS.md docs/ARCHITECTURE.md docs/architecture/README.md docs/architecture/LANES.md docs/architecture/M1_ADMIN_DIAGNOSTICS_REPAIR_COVERAGE.md .trellis/tasks/06-06-m1-admin-diagnostics-repair-coverage-audit`
