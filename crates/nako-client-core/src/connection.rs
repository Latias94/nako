...
pub fn advance_connection_probe(
    ...
    match response.request_id.as_str() {
        ...
        _ => CoreConnectionProbeOutcome::failure(crate::CoreRuntimeFailure {
            ...
            observed_api_version: header_value(response, nako_client_protocol::API_VERSION_HEADER)
                .map(str::to_owned),
            public_error: None,
            request: None,
        }),
...
fn interpret_health_response(
    ...
    let health =
        match serde_json::from_str::<nako_client_protocol::HealthResponse>(&response.body_utf8) {
    ...
    if health.version != nako_client_protocol::CLIENT_PROTOCOL_VERSION {
        return CoreConnectionProbeOutcome::failure(crate::CoreRuntimeFailure {
...
fn interpret_auth_probe_response(
    ...
    CoreConnectionProbeOutcome::success(CoreConnectionProbeSuccess {
        api_version: nako_client_protocol::CLIENT_PROTOCOL_VERSION.to_owned(),
