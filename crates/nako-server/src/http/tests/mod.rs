...
use nako_api::{
    ...
    extension::{
        ...
        AutomationProviderResponse, AutomationProvidersResponse, CancelAddonTaskRunRequest,
        ClaimAddonTaskRunRequest, ClaimAddonTaskRunResponse, CompleteAddonTaskRunRequest,
        CreateAddonTaskRunRequest, EnqueueAutomationJobRequest, FailAddonTaskRunRequest,
...
use nako_core::{
    AcquisitionIntakeCandidateState, AcquisitionIntakeRepository, AddonId, AddonPermission,
