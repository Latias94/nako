...
use nako_api::{
    ...
    extension::{
        ...
        AdminAddonHealthCheckResponse, AdminAddonHealthCheckStatus,
        AdminAddonInstallGuidePreviewRequest, AdminAddonInstallGuidePreviewResponse,
        AdminAddonInstallGuideResponse, AdminAddonLifecycleIntent, AdminAddonManagerPlanRequest,
        AdminAddonManagerPlanResponse, AdminAddonRegistrationResponse,
        ...
        AdminAddonRoutingPlansResponse, AdminAddonRuntimeReadinessReason,
        AdminAddonRuntimeReadinessResponse, AdminAddonRuntimeReadinessStatus,
        AdminAddonSurfacesResponse, AutomationArtifactsResponse, AutomationProviderResponse,
        AutomationProvidersResponse, EnqueueAutomationJobRequest, IssueAddonTokenRequest,
        RegisterAddonRequest, ReplaceAddonGrantsRequest, SubmitAddonAcquisitionCandidateRequest,
...
use nako_core::{
    AcquisitionIntakeCandidateState, AcquisitionIntakeRepository, AddonPermission, AddonRepository,
    AddonRoutingPlanStatus, AddonRoutingPlanTarget, AddonSideEffectApplyStatus,
    ...
    MetadataProviderErrorClass, MetadataRepository, MetadataSource, NakoError,
