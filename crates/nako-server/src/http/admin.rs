...
use nako_api::{
    admin::{
        ...
        AdminPlaybackSessionAdmissionDiagnostics, AdminPlaybackSessionListItem,
        AdminPlaybackSessionListResponse, AdminPlaybackStagingDiagnostics,
        AdminPlaybackSupportClientEvidence, AdminPlaybackSupportEvidenceResponse,
...
fn admin_system_config_response(app: &NakoApp) -> AdminServerConfigDiagnosticsResponse {
    ...
    AdminServerConfigDiagnosticsResponse {
        ...
        playback: AdminConfigPlaybackDiagnostics {
            ...
            active_playback_session_limit: config.playback.active_playback_session_limit,
...
async fn admin_playback_runtime_diagnostics(
    ...
    AdminPlaybackRuntimeDiagnosticsResponse {
        ...
        session_admission: AdminPlaybackSessionAdmissionDiagnostics {
            active_session_limit: usize_to_u32(playback.active_playback_session_limit),
            idle_session_timeout_ms: playback.idle_playback_session_timeout_ms,
        },
        staging,
        artifact_lifecycle,
        throttle,
