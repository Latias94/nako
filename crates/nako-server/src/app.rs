...
pub(crate) use storage::{
    ...
    StagingCleanupPurposeStateSummary, StagingPurposeStateSummary, StorageStagingPressureStatus,
    VfsCacheRepairActionBoundary, VfsCacheRepairActionPlanReason, VfsCacheRepairActionPlanReport,
    VfsCacheRepairActionPlanStatus, VfsCacheRepairAutomationBlockReason,
    VfsCacheRepairAutomationPolicy, VfsCacheRepairCommandOutput, VfsCacheRepairExecutableRoute,
