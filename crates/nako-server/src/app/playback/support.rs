...
pub(super) fn runtime_diagnostics(
    ...
    PlaybackRuntimeDiagnostics {
        ...
        active_playback_session_limit: config.playback.active_playback_session_limit.max(1),
        idle_playback_session_timeout_ms: config.playback.idle_playback_session_timeout_ms.max(1),
