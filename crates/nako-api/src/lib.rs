...
pub(crate) const PROVIDER_GOVERNANCE_PUBLIC_FORBIDDEN_TERMS: &[&str] = &[
    ...
    "related_hierarchy",
    "relatedhierarchy",
    "related-hierarchy/application-plan",
    "related_hierarchy_application_plan",
    "relatedhierarchyapplicationplan",
    "related-hierarchy/apply",
    "related_hierarchy_apply",
    "relatedhierarchyapply",
