...
pub fn kotlin_sdk() -> String {
    ...
    let mut output = String::new();
    output.push_str("// Generated by `cargo run -p taru-api --example emit-kotlin-sdk`.\n");
    output.push_str("// Do not edit generated output by hand.\n\n");
    output.push_str("@file:Suppress(\"unused\")\n\n");
    output.push_str("package dev.taru.sdk\n\n");
    ...
    output.push_str(&format!(
        "public const val TARU_API_VERSION: String = {:?}\n",
        API_VERSION
    ));
    output.push_str(&format!(
        "public const val TARU_API_VERSION_HEADER: String = {:?}\n",
        API_VERSION_HEADER
    ));
    output.push_str(&format!(
        "public const val TARU_PLAYBACK_SESSION_ID_HEADER: String = {:?}\n\n",
        PLAYBACK_SESSION_ID_HEADER
    ));
    output.push_str("public val TARU_PUBLIC_PATHS: List<String> = listOf(\n");
    for path in public_client_paths() {
...
const KOTLIN_CLIENT_RUNTIME: &str = r#"public data class TaruRequestDescriptor(
...
mod tests {
    ...
    fn kotlin_sdk_package_entry_matches_generator_output() {
        ...
        let package_entry =
            include_str!("../../../sdk/kotlin/src/main/kotlin/dev/taru/sdk/TaruClientSdk.kt")
                .replace("\r\n", "\n");

        assert_eq!(
            package_entry, generated,
            "run `cargo run -q -p taru-api --example emit-kotlin-sdk -- --output sdk/kotlin/src/main/kotlin/dev/taru/sdk/TaruClientSdk.kt` to refresh the Kotlin SDK package entry"
        );
    }
}
