...
use taru_api::{
    ...
    extension::{
        ...
        AdminAddonResourceCallDiagnosticStatus, AdminAddonRuntimeReadinessReason,
...
use taru_core::{
    AcquisitionIntakeCandidateState, AddonPermission, AddonRepository, AddonSideEffectApplyStatus,
