...
use super::{PostgresStore, database_error, i64_to_u64, row_get, u64_to_i64};

#[async_trait::async_trait]
impl AdminSettingsRepository for PostgresStore {
    ...
    async fn get_admin_settings_document(
        ...
        let row = sqlx::query(
            r#"
            SELECT key, payload_json::text AS payload_json, source, effect, updated_at_ms
