...
impl MetadataRepository for SqliteStore {
    ...
    async fn commit_metadata_refresh(
        ...
        crate::sqlite::provider_mapping::upsert_provider_subject_tx(
            &mut transaction,
        ...
        crate::sqlite::provider_mapping::upsert_provider_mapping_tx(&mut transaction, &mapping)
            .await?;
        ...
        for library_id in &confirmed_libraries {
            crate::sqlite::library_item::upsert_library_item_state_tx(
                &mut transaction,
                &LibraryItemState {
...
mod tests {
    use nako_core::{
        ...
        CatalogRepository, CatalogSearchProjection, DatabaseLifecycle, ExternalProvider, Genre,
        GenreId, ItemGenre, Library, LibraryId, LibraryItemRepository, LibraryItemState,
        LibraryOptions, LibraryPreset, LibraryRepository, MediaItem, MediaItemId, MediaKind,
        MediaRepository, MetadataField, MetadataFieldLock, MetadataRefreshPersistenceCommit,
        MetadataRefreshProviderMappingCommit, MetadataRepository, MetadataSource,
        NfoImportPersistenceCommit, ProviderMappingRepository, ProviderRawResponse,
        ProviderSubject, ProviderSubjectId, ProviderSubjectKind,
    };
    ...
    async fn commit_metadata_refresh_updates_metadata_provider_mapping_and_library_state() {
        ...
        let mappings = store
            .list_provider_mappings_for_item(item_id, nako_core::PageRequest::first_page())
            .await
            .unwrap();
