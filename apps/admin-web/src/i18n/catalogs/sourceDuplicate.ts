export const enSourceDuplicateMessages = {
  ...
  "sourceDuplicate.filter.status": "Relationship status",
  "sourceDuplicate.filter.statusAria": "Source duplicate relationship status filter",
  "sourceDuplicate.filter.anyStatus": "Any status",
  "sourceDuplicate.filter.action": "Recommended action",
  "sourceDuplicate.filter.actionAria": "Source duplicate recommended action filter",
  "sourceDuplicate.filter.anyAction": "Any action",
  "sourceDuplicate.filter.freshness": "Freshness",
  "sourceDuplicate.filter.freshnessAria": "Source duplicate freshness filter",
  "sourceDuplicate.filter.anyFreshness": "Any freshness",
  "sourceDuplicate.filter.active": "{count} filters",
  "sourceDuplicate.quick.pendingSuggestion": "Pending Suggestion",
  "sourceDuplicate.quick.suggestedReview": "Suggested Review",
  "sourceDuplicate.quick.confirmed": "Confirmed",
  "sourceDuplicate.quick.rejected": "Rejected",
  "sourceDuplicate.quick.refreshNeeded": "Refresh Needed",
  "sourceDuplicate.quick.stale": "Stale",
  ...
  "sourceDuplicate.clear": "Clear",
  "sourceDuplicate.status.none": "none",
  "sourceDuplicate.status.suggested": "suggested",
  "sourceDuplicate.status.confirmed": "confirmed",
  "sourceDuplicate.status.rejected": "rejected",
  ...
  "sourceDuplicate.reviewSummary.description":
    "{filtered} of {total} returned candidates match the active filters.",
  ...
  "sourceDuplicate.reviewSummary.filteredValue":
    "{filtered}/{total} candidates shown",
...
export const zhHansSourceDuplicateMessages = {
  ...
  "sourceDuplicate.filter.status": "关系状态",
  "sourceDuplicate.filter.statusAria": "Source duplicate 关系状态过滤器",
  "sourceDuplicate.filter.anyStatus": "任意状态",
  "sourceDuplicate.filter.action": "推荐动作",
  "sourceDuplicate.filter.actionAria": "Source duplicate 推荐动作过滤器",
  "sourceDuplicate.filter.anyAction": "任意动作",
  "sourceDuplicate.filter.freshness": "新鲜度",
  "sourceDuplicate.filter.freshnessAria": "Source duplicate 新鲜度过滤器",
  "sourceDuplicate.filter.anyFreshness": "任意新鲜度",
  "sourceDuplicate.filter.active": "{count} 个过滤器",
  "sourceDuplicate.quick.pendingSuggestion": "待建议",
  "sourceDuplicate.quick.suggestedReview": "建议审核",
  "sourceDuplicate.quick.confirmed": "已确认",
  "sourceDuplicate.quick.rejected": "已拒绝",
  "sourceDuplicate.quick.refreshNeeded": "需要刷新",
  "sourceDuplicate.quick.stale": "过期",
  "sourceDuplicate.limit": "Limit",
  ...
  "sourceDuplicate.clear": "清除",
  "sourceDuplicate.status.none": "无",
  "sourceDuplicate.status.suggested": "已建议",
  "sourceDuplicate.status.confirmed": "已确认",
  "sourceDuplicate.status.rejected": "已拒绝",
