...
export const mockOverview: AdminOverviewResponse = {
    ...
    checks: [
      {
        area: "setup",
        status: "ready",
        reason: "auth_configured",
        source_reason: null,
        attention_count: 0,
        action: null,
      },
      {
        area: "media_library_scan",
        status: "degraded",
        reason: "scan_repair_pressure",
        source_reason: "failed_work",
        attention_count: 3,
        action: {
          route_key: "jobs",
          route_path: NAKO_ADMIN_ROUTES.jobs,
        },
      },
      {
        area: "playback",
        ...
        source_reason: "ffmpeg_probe_ready",
        attention_count: 0,
        action: null,
      },
      {
      ...
      },
      {
        ...
        source_reason: "degraded_backends",
        attention_count: 1,
        action: {
          route_key: "storageVfsCacheRepairTargets",
          route_path: NAKO_ADMIN_ROUTES.storageVfsCacheRepairTargets,
        },
      },
      {
        area: "network",
        status: "ready",
        reason: "network_ready",
        source_reason: "local_only",
        attention_count: 0,
        action: null,
      },
      {
        area: "backup",
        status: "ready",
        reason: "backup_runbook_available",
        source_reason: "backup_restore_runbook",
        attention_count: 0,
        action: null,
      },
    ],
  ...
  source_fingerprint_hash: {
    total_sources: 128,
    fingerprinted_sources: 109,
    content_hash_sources: 84,
    queued_jobs: 6,
    running_jobs: 1,
    succeeded_jobs: 72,
    failed_jobs: 2,
    ...
    oldest_queued_at: "2026-06-05T00:00:00.000Z",
    next_retry_at: "2026-06-05T00:05:00.000Z",
  },
  startup: {
      ...
      diagnostics: [
        {
          ...
          last_tick: {
            ...
            scan_admission_status: "reused_running",
            scan_job_id: "job-watch-folder-running",
        ...
        },
        {
          ...
          root_ref_redacted: "local://<redacted>",
          status: "started",
          safe_reason: "local watch-folder runtime started",
          last_tick: null,
        },
      ],
    },
  ...
  active_suppressions: [
    {
      target_library_id: "library-anime",
      scope_scheme: "local",
      scope_ref_redacted: "local://<redacted>",
      owner: "nfo",
      reason: "sidecar_write",
      expires_at_ms: 1779180600000,
      completion: "suppress_only",
    },
  ],
  failures: [],
...
export const mockAddonTaskRuns: AddonTaskRunsResponse = {
  runs: [
    {
      job_id: "job-addon-task-run-failed",
      addon_id: "addon-subtitle-lab",
      manifest_id: "dev.nako.subtitle-lab",
      manifest_version: "0.3.0",
      manifest_fingerprint: "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      declaration_id: "scan-missing-subtitles",
      declaration_name: "Scan missing subtitles",
      declaration_path: "/tasks/missing-subtitles",
      status: "failed",
      resource_class: "addon.task.subtitle",
      library_id: "library-anime",
      source_id: null,
      attempt: 1,
      max_attempts: 3,
      ...
      safe_error_code: "retryable_http_failure",
      cancel_requested_at: null,
      queued_at: "2026-05-22T02:42:00.000Z",
      started_at: "2026-05-22T02:43:00.000Z",
      completed_at: "2026-05-22T02:44:00.000Z",
      updated_at: "2026-05-22T02:44:00.000Z",
    },
    {
      job_id: "job-addon-task-run-succeeded",
      addon_id: "addon-subtitle-lab",
      manifest_id: "dev.nako.subtitle-lab",
      manifest_version: "0.3.0",
      ...
      progress: null,
      result: {
        unsafe_sidecar_url: "http://subtitle-lab:9100/result",
      },
      safe_error_code: null,
      cancel_requested_at: null,
      queued_at: "2026-05-22T01:42:00.000Z",
      started_at: "2026-05-22T01:43:00.000Z",
      completed_at: "2026-05-22T01:44:00.000Z",
      updated_at: "2026-05-22T01:44:00.000Z",
    },
  ],
};

export const mockAddonTaskRunRetryResponse: AddonTaskRunResponse = {
  run: {
    ...mockAddonTaskRuns.runs[0],
    job_id: "job-addon-task-run-retry",
    status: "queued",
    attempt: 2,
    retry_of_job_id: mockAddonTaskRuns.runs[0].job_id,
    retryable: false,
    safe_error_code: null,
    started_at: null,
    completed_at: null,
    queued_at: "2026-05-22T02:50:00.000Z",
    updated_at: "2026-05-22T02:50:00.000Z",
  },
  idempotent_replay: false,
};
...
export const mockAddonsRouteSummary: AddonsRouteSummary = {
  ...
  taskRuns: mockAddonTaskRuns.runs.map((run) => ({
    jobId: run.job_id,
...
export const mockJobs: AdminJobListResponse = {
  ...
  jobs: [
    ...
    },
    {
      ...
      attempt: 2,
      max_attempts: 3,
      retry_of_job_id: "job-source-hash-original",
      next_attempt_at: null,
...
export const mockPlaybackRuntime: AdminPlaybackRuntimeDiagnosticsResponse = {
  ...
  profile_presets: [
    ...
    {
      family: "tv_tizen",
      device_family: "tv_tizen",
      profile_version: 1,
      direct_play: true,
      containers: ["mp4", "m4v", "matroska,webm"],
...
export const mockPlaybackSupport: AdminPlaybackSupportEvidenceResponse = {
  ...
  client: {
    ...
    device_family: "browser_chromium",
    profile_version: 1,
    profile_family: "browser_chromium",
    direct_play: false,
    containers: ["mp4", "webm"],
    video_codecs: ["h264"],
...
export const mockVfsCacheRepairRetryJob: AdminJobListItem = {
  ...
  attempt: 2,
  max_attempts: 3,
  retry_of_job_id: "job-vfs-cache-repair-failed",
  ...
  summary: {
    ...
    purpose_state_summaries: [
      ...
      },
      {
        ...
        state: "ready",
        record_count: 1,
        used_manifest_bytes: 1468006400,
        active_leases: 1,
