package dev.taru.android.uniffi
...
import uniffi.taru_client_uniffi.buildPlaybackDecisionRequest

@RunWith(AndroidJUnit4::class)
class TaruUniFfiNativeSmokeTest {
    @Test
    fun packaged_uniffi_library_loads_and_builds_core_request() {
        val request = buildPlaybackDecisionRequest(
            baseUrl = "https://taru.example/api",
        ...
        assertEquals(
            "https://taru.example/api/sources/source%201/playback/decision?direct_play=true&container=mp4%2Cwebm&video_codec=h264&audio_codec=aac",
            request.url,
        )
