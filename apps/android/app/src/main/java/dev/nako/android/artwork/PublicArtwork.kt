...
import dev.nako.android.connection.toAndroidPreview
import dev.nako.android.connection.toAndroidRequest
import uniffi.nako_client_uniffi.CoreArtworkImageRequestInput
...
object RustArtworkCore : ArtworkCore {
    override fun image(
        ...
        uniffi.nako_client_uniffi.buildArtworkImageRequest(
