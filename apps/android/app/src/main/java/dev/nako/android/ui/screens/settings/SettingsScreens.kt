...
import dev.nako.android.ui.browse.PageTitle
import dev.nako.android.ui.browse.SectionLabel
...
import dev.nako.android.ui.components.NakoStatusPill
    ...
    NakoScreenColumn {
        ...
        SettingsGroup(
            ...
            rows = listOf(
                ...
                SettingsRow(
                    ...
                    accessibilityLabel = stringResource(NakoStrings.copyDiagnosticsAccessibility),
                    onClick = { clipboard.copyPlainText("Nako diagnostics", diagnostics.report) },
                ),
            ),
        )
        ...
        SettingsGroup(
            ...
            rows = listOf(
                ...
                SettingsRow("Version", "Nako 0.1.0", Icons.Rounded.Info),
            ),
        )
    }
}
...
internal fun ServerProfileScreen(
    ...
    NakoScreenColumn {
        Row(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(NakoSpacing.xsmall)) {
                Text(
                    text = "Server Profile",
    ...
    Surface(
        ...
        Column(
            ...
            Row(
                ...
                NakoStatusChip(text = "Compatibility ${diagnostics.apiLabel}")
            }
            Row(horizontalArrangement = Arrangement.spacedBy(NakoSpacing.small)) {
                ...
                OutlinedButton(onClick = onChangeServer) {
                    Text(stringResource(NakoStrings.switchServer))
                }
            }
        }
    }
...
private fun AccessTokenPanel(onChangeServer: () -> Unit) {
    NakoSurfaceCard {
        Row(
            ...
            NakoIconBadge(icon = Icons.Rounded.Lock)
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = "Server sign-in",
...
private fun SettingsListRow(row: SettingsRow) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
            .heightIn(min = NakoTouchTarget.minimum)
            .semantics {
