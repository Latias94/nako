...
import uniffi.nako_client_uniffi.CoreConnectionProbeOutcome as UniFfiConnectionProbeOutcome
import uniffi.nako_client_uniffi.CoreConnectionProbeOutcomeKind as UniFfiConnectionProbeOutcomeKind
import uniffi.nako_client_uniffi.CoreHttpHeader
import uniffi.nako_client_uniffi.CoreHttpRequest
import uniffi.nako_client_uniffi.CoreHttpResponse
import uniffi.nako_client_uniffi.CoreRuntimeFailure
import uniffi.nako_client_uniffi.CoreRuntimeFailureKind
import uniffi.nako_client_uniffi.CoreSafeRequestPreview

internal data class ConnectionCoreRequest(
    val requestId: String,
    val httpRequest: NakoHttpRequest,
...
internal object RustConnectionCore : ConnectionCore {
    override fun startConnectionProbe(
        ...
        uniffi.nako_client_uniffi.startConnectionProbe(
            baseUrl = baseUrl,
    ...
    override fun advanceConnectionProbe(
        ...
        uniffi.nako_client_uniffi.advanceConnectionProbe(
            baseUrl = baseUrl,
            accessToken = accessToken,
...
internal fun CoreHttpRequest.toAndroidRequest(): NakoHttpRequest =
    NakoHttpRequest(
        method = method,
        url = url,
...
private fun NakoHttpResponse.toCoreResponse(requestId: String): CoreHttpResponse =
    CoreHttpResponse(
        requestId = requestId,
