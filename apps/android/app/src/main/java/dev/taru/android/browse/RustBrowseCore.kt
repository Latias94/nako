...
import uniffi.taru_client_uniffi.CoreBrowseEntityPagedRequestInput
import uniffi.taru_client_uniffi.CoreBrowseEntityRequestInput
import uniffi.taru_client_uniffi.CoreBrowsePagedRequestInput
import uniffi.taru_client_uniffi.CoreHttpRequest
import uniffi.taru_client_uniffi.CorePageQuery
import uniffi.taru_client_uniffi.CoreSearchItemsRequestInput
...
internal object RustBrowseCore : BrowseCore {
    override fun listLibraries(
        ...
        uniffi.taru_client_uniffi.buildListLibrariesRequest(
    ...
    override fun libraryDetail(
        ...
        uniffi.taru_client_uniffi.buildGetLibraryRequest(
    ...
    override fun librarySources(
        ...
        uniffi.taru_client_uniffi.buildListLibrarySourcesRequest(
    ...
    override fun listItems(
        ...
        uniffi.taru_client_uniffi.buildListItemsRequest(
            pagedInput(profile, accessToken, page),
        ).toBrowseDescriptor()
    ...
    override fun searchItems(
        ...
        uniffi.taru_client_uniffi.buildSearchItemsRequest(
    ...
    override fun itemDetail(
        ...
        uniffi.taru_client_uniffi.buildGetItemRequest(
    ...
    override fun itemImages(
        ...
        uniffi.taru_client_uniffi.buildListItemImagesRequest(
            entityInput(profile, accessToken, itemId),
        ).toBrowseDescriptor()
    ...
    override fun personDetail(
        ...
        uniffi.taru_client_uniffi.buildGetPersonRequest(
    ...
    override fun listPersonItems(
        ...
        uniffi.taru_client_uniffi.buildListPersonItemsRequest(
    ...
    override fun listGenres(
        ...
        uniffi.taru_client_uniffi.buildListGenresRequest(
            pagedInput(profile, accessToken, page),
        ).toBrowseDescriptor()
    ...
    override fun listGenreItems(
        ...
        uniffi.taru_client_uniffi.buildListGenreItemsRequest(
    ...
    override fun listTags(
        ...
        uniffi.taru_client_uniffi.buildListTagsRequest(
            pagedInput(profile, accessToken, page),
        ).toBrowseDescriptor()
    ...
    override fun listTagItems(
        ...
        uniffi.taru_client_uniffi.buildListTagItemsRequest(
