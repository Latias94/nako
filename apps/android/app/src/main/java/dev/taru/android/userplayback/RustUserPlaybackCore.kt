...
import uniffi.taru_client_uniffi.CoreUserPlaybackItemRequestInput
import uniffi.taru_client_uniffi.CoreUserPlaybackItemWriteRequestInput
import uniffi.taru_client_uniffi.CoreUserPlaybackPagedRequestInput
...
internal object RustUserPlaybackCore : UserPlaybackCore {
    override fun getState(
        ...
        uniffi.taru_client_uniffi.buildGetUserPlaybackStateRequest(
    ...
    override fun continueWatching(
        ...
        uniffi.taru_client_uniffi.buildListContinueWatchingRequest(
    ...
    override fun updateProgress(
        ...
        uniffi.taru_client_uniffi.buildUpdateUserPlaybackProgressRequest(
    ...
    override fun setWatchedState(
        ...
        uniffi.taru_client_uniffi.buildSetUserWatchedStateRequest(
            itemWriteInput(profile, accessToken, itemId, bodyUtf8),
        ).toUserPlaybackDescriptor()
}
